      ...
      {open && task ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-y-0 left-0 z-[90] flex w-[45vw] sm:w-full flex-col border-r border-[var(--border)] bg-[var(--surface)] shadow-[0_24px_80px_rgba(15,23,42,0.18)] sm:max-w-[420px]"
          >
