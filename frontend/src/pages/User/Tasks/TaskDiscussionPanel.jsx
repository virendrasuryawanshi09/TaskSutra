...
const TaskDiscussionPanel = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 z-[80] flex h-screen w-[70vw] sm:w-full sm:max-w-[350px] flex-col border-l border-[var(--border)] bg-[var(--surface)] transition-transform duration-200 ${
