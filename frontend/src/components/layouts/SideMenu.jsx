...
const SideMenu = () => {
  ...
  return (
    <div className="flex h-full min-h-[calc(100dvh-4rem)] w-full flex-col overflow-y-auto border-r border-[var(--border)] bg-[var(--surface)] p-4 lg:sticky lg:top-16 lg:h-[calc(100dvh-4rem)]">
